      ...
      return BbPromise.resolve(this.targetFuncs)
        ...
        .map((f) => {
          ...
          if (this.progress && this.log) {
            ...
            this.log.info(`Zipping required Python packages for ${extraRequirementsPathHash}...`);
          } else {
            this.serverless.cli.log(
              `Zipping required Python packages for ${extraRequirementsPathHash}...`
            );
          }
          f.package.patterns.push(`${extraRequirementsPathHash}/.requirements.zip`);
          return addTree(new JSZip(), `.serverless/${extraRequirementsPathHash}/requirements`)
